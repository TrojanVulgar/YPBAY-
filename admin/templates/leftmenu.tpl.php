...
<table width="220" border="0" cellpadding="0" cellspacing="0" class="fside">
	...
	<tr>
		<td colspan="2">
			...
			<? if (
				...
				(eregi("general_settings.php",$_SERVER['PHP_SELF']) && $_REQUEST['page']=='buy_out_method') || 
		...
		<td colspan="2">
         <div id="exp2" style="padding: 5px;">
			...
			<? if (
				...
				(eregi("enable_disable.php",$_SERVER['PHP_SELF']) && $_REQUEST['page']=='buy_out_method') ||
	...
	<tr>
		<td colspan="2">
			...
			<? if (
				...
				eregi("table_postage_tiers.php",$_SERVER['PHP_SELF'])||
	...
	<tr>
		<td colspan="2">
			...
			<? if (
				...
				eregi("shipping_carriers.php",$_SERVER['PHP_SELF']) ||
				eregi("list_retracted_bids.php",$_SERVER['PHP_SELF']) ||
	...
	<tr>
		<td colspan="2">
			...
			<? if (
				eregi("list_reverse.php",$_SERVER['PHP_SELF'])||
				eregi("list_awarded.php",$_SERVER['PHP_SELF'])||
				eregi("table_reverse_budgets.php",$_SERVER['PHP_SELF'])||
				(eregi("table_categories.php",$_SERVER['PHP_SELF']) && $_REQUEST['table'] == 'reverse') ||
				(eregi("categories_lang.php",$_SERVER['PHP_SELF']) && $_REQUEST['table'] == 'reverse') ||
	...
	<tr>
		<td colspan="2">
			...
			<? if (
				...
				eregi("refund_requests.php",$_SERVER['PHP_SELF'])||

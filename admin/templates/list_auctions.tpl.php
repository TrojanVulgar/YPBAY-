         	...
         	<table width="100%" border="0" cellpadding="3" cellspacing="1" class="border">
               ...
               <tr class="c4">
                  ...
                  <td align="center"><?=AMSG_APPROVE;?>
                     <br>
                     [ <a href="javascript:void(0);" onclick="checkAll(document.select_auctions['approve[]'], <?=$nb_auctions;?>, true);"> <font color="#EEEE00">
                     <?=GMSG_ALL;?></font></a> | 
                     <a href="javascript:void(0);" onclick="checkAll(document.select_auctions['approve[]'], <?=$nb_auctions;?>, false);"> <font color="#EEEE00">
                     <?=GMSG_NONE;?></font></a> ] </td>
                  <? } else { ?>
                  <td align="center" width="150"><?=GMSG_STATUS;?>
                     <br />
                     [ <a href="javascript:void(0);" onclick="checkAll2(document.select_auctions['activate[]'], document.select_auctions['inactivate[]'], <?=$nb_auctions;?>, true);"> <font color="#EEEE00">
                     <?=AMSG_ACTIVATE_ALL;?></font></a> ]
                     [ <a href="javascript:void(0);" onclick="checkAll2(document.select_auctions['activate[]'], document.select_auctions['inactivate[]'], <?=$nb_auctions;?>, false);"> <font color="#EEEE00">
                  ...
                  <td align="center"><?=AMSG_CLOSE;?>
                     <br />
                     [ <a href="javascript:void(0);" onclick="checkAll(document.select_auctions['close[]'], <?=$nb_auctions;?>, true);"> <font color="#EEEE00">
                     <?=GMSG_ALL;?></font></a> | 
                     <a href="javascript:void(0);" onclick="checkAll(document.select_auctions['close[]'], <?=$nb_auctions;?>, false);"> <font color="#EEEE00">
                     <?=GMSG_NONE;?></font></a> ] </td>                  
                  <? } ?>
                  <td align="center"><?=AMSG_DELETE;?>
                     <br />
                     [ <a href="javascript:void(0);" onclick="checkAll(document.select_auctions['delete[]'], <?=$nb_auctions;?>, true);"> <font color="#EEEE00">
                     <?=GMSG_ALL;?></font></a> | 
                     <a href="javascript:void(0);" onclick="checkAll(document.select_auctions['delete[]'], <?=$nb_auctions;?>, false);"> <font color="#EEEE00">
                     <?=GMSG_NONE;?></font></a> ] </td>
               </tr>
               <?=$auctions_content;?>
            </table></td>

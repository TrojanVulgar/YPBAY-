...
<form action="content_pages.php" method="post" name="form_content_pages">
	...
	<table width="100%" border="0" cellpadding="3" cellspacing="3" class="fside">
      ...
      <tr class="c1">
         ...
         <td width="100%"><textarea id="topic_content_<?=$value;?>" name="topic_content_<?=$value;?>" style="width: 400px; height: 200px; overflow: hidden;"><?=$row_topic['topic_content'];?></textarea>
            <script>

   ...
   <tr valign="top">
      ...
      <td width="100%"><table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr align="center" valign="top">
               ...
               <td width="14%"><a href="http://www.yoursite.com/client/support/pdesk.cgi" target="_blank"><img src="images/support.gif" border="0"></a>
                  <div style="icontext">
                     <?=AMSG_SUPPORT_DESK;?>
                  </div></td>
               <td width="14%"><a href="http://www.yoursite.com/client/manuals/manual.pdf" target="_blank"><img src="images/manual.gif" border="0"></a>
                  <div style="icontext">
                     <?=AMSG_PPB_MANUAL;?>
                  </div></td>

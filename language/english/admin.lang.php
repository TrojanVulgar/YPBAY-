...
define ('AMSG_PRIVATE_SITE', 'Private Site/Single Seller');
...
define('AMSG_CRON_JOB_PPB', 'Run cron jobs from PHP Pro Bid');
...
define('AMSG_SWAP_FEE_DESC', 'Enter a fee that will be charged when an item is swapped. This can be a flat fee, or a percentage based on the start price/reserve price.');
...
define ('AMSG_TO_DO_TAX_2', 'unconverted site fees invoice rows and ');
define ('AMSG_TO_DO_TAX_3', 'unconverted product invoice rows');
define ('AMSG_CLICK', 'Click');
define ('AMSG_HERE', 'here');
define ('AMSG_TO_DO_TAX_4', 'for more details');
define ('AMSG_TAX_CONVERSION', 'Tax Fields Conversion');
define ('AMSG_TO_DO_TAX_5', 'to start the conversion process. It might take a few minutes.');
...
define ('AMSG_DD_DISCLAIMER_EXPL', 'Enter a disclaimer paragraph which will be shown to users downloading files from the site before proceeding with the download.');
...
define ('AMSG_SHOW_LINK_HP', 'Show Link on Home Page');
define ('AMSG_CURRENCY_CODE', 'Currency Code<br>(ISO 4217)');
define ('AMSG_ENABLE_SITE_SHARING', 'Enable Site Sharing (through AddThis.com)');
define ('AMSG_ABUSE_REPORTS_TITLE', 'Abuse Reports');
define ('AMSG_TASKS', 'Tasks');
define ('AMSG_SUGGESTED_CATEGORIES', 'Suggested Categories');
define ('AMSG_SERVER_INFO', 'Server Information');
define ('AMSG_SERVER_SOFTWARE', 'Server Software');
define ('AMSG_SERVER_NAME', 'Name');
define ('AMSG_SERVER_ADDRESS', 'Address');
define ('AMSG_SERVER_PORT', 'Port');
define ('AMSG_GD_VERSION', 'GD Version');
define ('AMSG_MYSQL_VERSION', 'MySQL');
define ('AMSG_STORE_OWNERS', 'Store Owners');
define ('AMSG_ENABLE', '');
...
define ('AMSG_BANNER_POSITION_EXPL', 'Choose the position of this banner on the site.');

define ('AMSG_SHOW_BANNERS_FROM_SECTION', 'Filter by Section');
define ('AMSG_ALL_SECTIONS', '-- All Sections --');

define ('AMSG_SMTP_HOST', 'SMTP Host');
...
define ('AMSG_REFUND_DAYS_INTERVAL_EXPL', 'Enter the timeframe when the payer is able to request a refund for an end of auction fee, or leave both fields empty (or 0) if you dont want to set a timeframe.');
define ('AMSG_REFUNDS_IMPORTANT_NOTE', '<b>Important</b>: Users will be able to ask for refunds only for end of auction fees which have been paid after ');
...
define ('AMSG_REVERSE_AUCTIONS_MANAGEMENT', 'Reverse Auctions Management');
...
define ('AMSG_ENABLE_END_AUCTION_EARLY_BID_EXPL', 'If this feature is enabled, sellers will be able to close their auctions early even if there is a high bid placed on them.');
define ('AMSG_VOUCHER_CODE_EXPL', 'Optional. If you leave this field empty, a voucher code will be automatically generated.');
define ('AMSG_BALANCE_ADJ_REASON', 'Balance Adjustment Reason');
define ('AMSG_REVERSE_AUCTION_FEES', 'Reverse Auction Fees');
define ('AMSG_SETUP_FEE_DESC', 'You can set a flat auction setup fee.');
define ('AMSG_REVERSE_BID_FEE_DESC', 'You can set a flat fee which users have to pay in order to be able to bid on a reverse auction.');
define ('AMSG_MAX_PORTFOLIO_FILES', 'Max. Portfolio Files');
define ('AMSG_MAX_PORTFOLIO_FILES_EXPL', 'Enter the maximum number of portfolio related files a provider is able to upload on the server.');
define ('AMSG_CUSTOM_PROVIDER_PROFILE_FIELDS_MANAGEMENT', 'Provider Profile Custom Fields Management');
define ('AMSG_AWARDED_PROJECTS', 'Projects Awarded');
define ('AMSG_MAX_ADDL_FILES', 'Max Additional Files');
define ('AMSG_MAX_ADDL_FILES_EXPL', 'Enter the maximum number of additional files a user can upload when a reverse auction is created.');
define ('AMSG_HPFEAT_RA', 'Home Page Featured Reverse Auctions');
define ('AMSG_CATFEAT_RA', 'Category Pages Featured Reverse Auctions');
define('AMSG_CUSTOM_REP_FIELDS_MANAGEMENT_POSTER', 'Custom Reputation Fields Setup (project poster)');
define('AMSG_CUSTOM_REP_FIELDS_MANAGEMENT_PROVIDER', 'Custom Reputation Fields Setup (provider)');
define ('AMSG_ENABLE_SIDEWIKI_BLOCKER', 'Google SideWiki Blocker');
define ('AMSG_ENABLE_SIDEWIKI_BLOCKER_EXPL', 'By enabling this feature, a hash will be applied to your urls so that Google SideWiki wont be able to apply links on your site.');
define ('AMSG_RECENT_REVERSE', 'Recently Listed Reverse Auctions');
define ('AMSG_RECENT_REVERSE_EXPL', 'Enter the number of recently listed reverse auctions that will be displayed on the home page of your site. (applies only for the ultra skin by default)');
define ('AMSG_ENABLE_CUSTOM_END_TIME', 'Enable Custom End Time');
define ('AMSG_ONLINE_USERS', 'Online Users');
...
define ('AMSG_GENERATE_SAMPLE_FILE', 'Generate Sample File');
define ('AMSG_GENERATE_SAMPLE_FILE_EXPL', 'Please generate the bulk sample file every time you make changes to your site\'s settings, to make sure the sample file contains the most up to date fields');
define ('AMSG_FROM_EMAIL_TITLE', 'Email Display Name');
define ('AMSG_FROM_EMAIL_TITLE_EXPL', 'Enter a display name which will appear on all emails sent from the administrator.');
define ('AMSG_BROWSE_THUMB_SIZE', 'Browse Pages Thumbnail Size');
define ('AMSG_BROWSE_THUMB_SIZE_EXPL', 'Enter the size for the thumbnails which will be shown on the browse pages.');
define ('AMSG_DISPLAY_FREE_FEES', 'Display Free Fees on the Front End');
define ('AMSG_SELLERS', 'All Sellers');
define ('AMSG_VERIFIED_SELLERS', 'Verified Sellers');
define ('AMSG_ENABLE_PROXY_BIDDING', 'Enable Proxy Bidding');
define ('AMSG_ENABLE_FREE_CATEGORY_CHANGE', 'Enable Free Category Change');
define ('AMSG_PREF_SELLERS', 'Preferred Sellers');
define ('AMSG_ENABLE_SITE_FEES_PAGE', 'Enable Site Fees Page');
define ('AMSG_THERE_ARE_A_TOTAL', 'There are a total of');
define ('AMSG_SUSPEND_AUCTION_CONFIRM', 'Are you sure you want to suspend this auction?');
define ('AMSG_SUSPEND_AUCTION', 'Suspend Auction');
define ('AMSG_AUCTION_SUSPENDED', 'The auction has been suspended successfully.');
define ('AMSG_CATEGORY_PASSWORD', 'Password');
define ('AMSG_CALCULATION_TYPE', 'Calculation Type');
define ('AMSG_CALCULATION_TYPE_EXPL', 'If we have two tiers:<br>
0.01 - 50 -> 10%<br>
50 - 1000 -> 5%<br>
and a sale price of 250, the standard method will calculate as follows:<br>
sale fee = 250 * 5% = 12.5<br>
while the progressive method will calculate as follows:<br>
sale fee = 50 * 10% + 200 * 5% = 15');
define ('AMSG_CLOSE', 'Close');
define ('AMSG_ENTER_CLOSURE_REASON', 'Enter reason for auction closure (optional)');
define ('AMSG_CSV_DELIMITER', 'CSV Delimiter');
define ('AMSG_CSV_DELIMITER_EXPL', 'Choose the column delimiter for the CSV files your members will be importing.');
define ('AMSG_SHIPPING_CARRIERS_MANAGEMENT', 'Shipping Carriers Management');
define ('AMSG_USPS_CARRIER_EXPL', 'If you dont have a user account with USPS, please click [ <a href="https://secure.shippingapis.com/registration/" target="_blank">here</a> ].<br>
Please note that you will have to email USPS and ask them to upgrade your account so that you are able to use the production server instead of the test server which they offer by default.');
define ('AMSG_FEDEX_CARRIER_EXPL', 'You will need a FedEx developer account in order to be able to use this carrier.<br>
Please click [ <a href="http://www.fedex.com/us/developer/index.html" target="_blank">here</a> ] to create a free developer account. You should receive the test account number and meter number by email after registration.');
define ('AMSG_ACCOUNT_NUMBER', 'Account Number');
define ('AMSG_METER_NUMBER', 'Meter Number');
define ('AMSG_SHIPPING_CARRIERS_NOTE', '<b>Important</b>: You will need to have CURL compiled with PHP in order to be able to use these shipping carriers (except for UPS).<br>
Please contact your host for more information about this.');
define ('AMSG_UPS_CARRIER_EXPL', 'The UPS rate calculator uses the fopen method, and its only an approximation of the live shipping rate. You dont need a UPS developer account for this method.<br>
The "allow_url_fopen" variable will need to be enabled when compiling PHP in order to use this method.');
define ('AMSG_VIEW_RETRACTED_BIDS', 'View Retracted Bids');
define ('AMSG_BIDDER', 'Bidder');
define ('AMSG_RETRACTION_DATE', 'Retraction Date');
define ('AMSG_COUNTRY_ISO_CODES_NOTE', '<b>Important</b>: The ISO Code field is used for the shipping carrier modules to parse the data correctly. 
Please do not edit the fields which are already filled by default.<br>
In order to view the ISO codes, please access this link: <a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2" target="_blank">http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2</a>');
define ('AMSG_ISO_CODE', 'ISO Code');
define ('AMSG_LIMIT_NB_BIDS', 'Limit number of bids/offers per user');
define ('AMSG_LIMIT_NB_BIDS_EXPL', 'If you enable this feature, your sellers will be able to limit the number of bids and/or offers a bidder can place on an auction (proxy bids are not taken into consideration).');
define ('AMSG_DEFAULT_SELECTED', 'Default Selected');
define ('AMSG_DURATIONS_FEE_DESC', 'Enter duration specific fees in the fields above, or leave the fields empty if no fees apply.');
define ('AMSG_SUSPENSION_DATE_DAYS', 'Cron Invoice Suspension');
define ('AMSG_SUSPENSION_DATE_DAYS_EXPL', '(Optional) Enter the number of days after which an account is suspended from the time an invoice cron email is sent, or enter 0 to disable this feature.<br>
Please note that you need to have the invoice cron email set in your server\'s cron jobs in order for this setting to work.');
define ('AMSG_SELLER_VERIF_REFUND', 'Refund Verification Fee');
define ('AMSG_SELLER_VERIF_REFUND_EXPL', 'If the checkbox above is checked, the verification fee will be credited to the seller\'s account after payment.<br>
The user\'s account will need to run in account mode for this feature to apply.');
define ('AMSG_AUCTIONS', 'Auctions');
define ('AMSG_WANTED_ADS', 'Wanted Ads');
define ('AMSG_AWAITING_APPROVAL', 'Awaiting Approval');

define ('AMSG_ENABLE_BIDDER_VERIFICATION', 'Enable Bidder Verification');
define('AMSG_BIDDER_VERIF_MANDATORY_EXPL', 'If the mandatory verification is enabled, all bidders will need to get verified in order to be able to bid on the site. <br>
Otherwise bidders will be able to bid on auctions even if they aren\'t verified.');
define('AMSG_BIDDER_VERIFICATION_FEE_EXPL', 'You can set up a one time or recurring verification fee. If you wish the verification fee 
to be a one time fee enter 0 in the recurring field.<br>
<b>Note</b>: Even if you disable seller verification, you will still be able to set the status of your users to verified bidders 
from the Users Management page. Users will however not be able to verify their accounts themselves.');
define ('AMSG_VERIFIED_BIDDER', 'Verified Bidder');
define ('AMSG_HIDE_EMPTY_STORES', 'Hide Empty Stores');
define ('AMSG_HIDE_EMPTY_STORES_EXPL', 'If the checkbox above is checked, stores with 0 items wont be shown on the stores page on the front end.');
define ('', '');
?>
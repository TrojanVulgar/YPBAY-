...
You will be notified by email when your account will be activated.<br>
An email has been sent to the address you have submitted with details on how to verify your email address.');
...
define ('MSG_ACCOUNT_ACTIVATION_ACC_APPROVAL', 'Your account hasn\'t been approved by the administrator yet or you havent verified your email address.<br>
If your account is pending admin approval, you will be notified by email when the account will be activated. <br>
...
define ('MSG_CURRENCY_EXPL', 'Choose your item\'s currency. ');
...
define ('MSG_NB_AUTO_RELISTS_EXPL', 'Enter the number of times the item will be relisted automatically.<br>
The maximum number of auto relists allowed is ' . $setts['nb_autorelist_max'] . '.');
...
define ('MSG_MM_DETAILS', 'Bulk Lister');
...
define ('MSG_MM_PREFILLED_FIELDS', 'Prefilled Fields/Global Settings');
...
define ('MSG_TRACK_BID_EXPL', 'You can track your bid through the <a href="members_area.php?page=bidding&section=current_bids">Members Area</a> and up your bid at any time to ensure you win the auction.');
...
define ('MSG_ASK_SELLER_QUESTION', 'Ask Poster a Question');
...
define ('MSG_SEARCH_RESERVE_PRICE_ITEMS', 'Reserve Price Items');
define ('MSG_SEARCH_QUANTITY_DUTCH', 'Dutch Auctions');
...
define ('MSG_SEARCH_SWAP_ENABLED', 'Swap Enabled');
...
define ('MSG_SEARCH_QUANTITY_DUTCH_ONLY', 'Dutch Auctions');
define ('MSG_SEARCH_QUANTITY_STANDARD_ONLY', 'Standard Auctions');
define ('MSG_SEARCH_DIRECT_PM_ONLY', 'Direct Payment');
define ('MSG_SEARCH_REGULAR_PM_ONLY', 'Regular Payment');
define ('MSG_SEARCH_PHOTOS_ONLY', 'Items with Photos');
...
define ('MSG_PAYPAL_ADDRESS_OVERRIDE', 'Invoicing Address');
...
Please click [ <a href="members_area.php?page=store&section=subscription">here</a> ] to access the stores management page.');
...
define ('MSG_SEARCH_DESCRIPTION', 'Search title &amp; description');
...
define ('MSG_DOWNLOAD_MEDIA', 'Download Media');
define ('MSG_LINK_EXPIRES', 'Link expires in');
...
define ('MSG_NO_DIGITAL_MEDIA', 'No Digital Media');
define ('MSG_FILTER_ITEMS', 'Filter Items');
...
define ('MSG_EDIT_DRAFT', 'Edit Draft');
define ('MSG_EDIT_MORE_DRAFTS', 'Edit More Drafts');
define ('MSG_YOUR_DRAFT', 'Your draft');
define ('MSG_BLOCK', 'Block');
define ('MSG_BLOCK_BID_EXPL', 'Block Bidding');
define ('MSG_BLOCK_MESSAGE_EXPL', 'Block the user\'s ability to send you messages through the site');
define ('MSG_BLOCK_REPUTATION_EXPL', 'Block the use\'s ability to view your reputation page');
define ('MSG_MESSAGING', 'Messaging');
define ('MSG_BLOCKED_USER_MESSAGE_MSG', 'This user has blocked you from sending him messages through the site.');
define ('MSG_BLOCKED_USER_REPUTATION_MSG', 'This user has blocked you from viewing his detailed reputation page.');
...
define ('MSG_FAILED_TO_RELIST', 'failed to relist. Please try again.');
...
define ('MSG_DEFAULT_TIERS_TABLE', 'Default Calculation Table');
define ('MSG_CUSTOM_TIERS_TABLE', 'Custom Calculation Table');
define ('MSG_ACTIVE_TIERS_TABLE', 'Active Calculation Table');
define ('MSG_WEIGHT_UNIT', 'Weight Unit');
define ('MSG_ADD_TIER', 'Add Tier');
define ('MSG_WEIGHT', 'Weight');
define ('MSG_WEIGHT_EXPL', 'Enter the weight of the item.');
define ('MSG_CREATE_INVOICE_NOTE', '<b>Important</b>: You need to select at least one item in order to create an invoice.');
define ('MSG_CREATE_PRODUCT_INVOICE', 'Create Product(s) Invoice');
...
define ('MSG_FB_DECREMENT_INTERVAL_EXPL', 'Enter the interval in which the price will decrement by the decrement amount set.');
define ('MSG_FRMCHK_RP_SP_FB_ERROR', 'The <b>Reserve Price</b> must be lower than the <b>Start Price</b> ');
define ('MSG_NEXT_DECREMENT', 'Next Decrement');
define ('MSG_FB_BIDDING_NOTE', '<b>Important</b>: While you are on this page, the auction is still running, and you can be outbid by another user unless the proceed button isnt clicked.');
define ('MSG_FB_PURCHASE_SUCCESS_EXPL', 'CONGRATULATIONS,<br>you have successfully won this auction!');
define ('MSG_MM_REVERSE_AUCTIONS', 'Reverse Auctions');
define ('MSG_MM_GET_SERVICES', 'Get Services');
define ('MSG_MM_PROVIDE_SERVICES', 'Provide Services');
define ('MSG_MM_MY_BIDS', 'My Bids');
define ('MSG_MM_MY_PROJECTS', 'My Projects');
define ('MSG_MM_CREATE_REVERSE_AUCTION', 'Post Project');
define ('MSG_MM_AWARDED', 'Awarded');
define ('MSG_SHIPPING_LOCATIONS', 'Shipping Locations');
define ('MSG_GLOBAL', 'Global');
define ('MSG_LOCAL', 'Local');
define ('MSG_SHIPPING_GLOBAL_EXPL', 'Select this option if your shipping rates apply to all users.');
define ('MSG_SHIPPING_LOCAL_EXPL', 'Select this option if your shipping rates only apply to certain locations.<br>You will need to define the locations where the default shipping rates will apply.');
define ('MSG_LOCATIONS', 'Locations');
define ('MSG_ADD_LOCATION', 'Add Location(s)');
define ('MSG_EDIT_LOCATION', 'Edit Location(s)');
define ('MSG_SET_AS_DEFAULT_LOC', 'Set As Default Location');
define ('MSG_NO_SHIPPING_LOCATIONS_SET', 'You don\'t have any shipping locations set at the moment');
define ('MSG_ADDITIONAL_COST', 'Additional Cost');
define ('MSG_SHIPPING_CALCULATOR', 'Shipping Calculator');
...
define ('MSG_PAY_REVERSE_SETUP_FEE', 'Pay Reverse Auction Setup Fee');
define ('MSG_BUDGET', 'Budget');
define ('MSG_EDIT_REVERSE', 'Edit Reverse Auction');
define ('MSG_SUBMIT_REVERSE', 'Submit Reverse Auction');
define ('MSG_REVERSE_AUCTION_DETAILS', 'Reverse Auction Details');
define ('MSG_REVERSE_AUCTION_TITLE', 'Auction Title');
define ('MSG_BUDGET_EXPL', 'Select a budget for your reverse auction.');
define ('MSG_REVERSE_PRIVATE_AUCTION_EXPL', 'By enabling this option, the bids placed on this auction will be hidden to other site users.');
define ('MSG_ADDITIONAL_FILES', 'Additional Files');
...
define ('MSG_BID_NOT_WITHIN_BUDGET', 'Your bid must be within the budget allotted by the project poster.');
define ('MSG_POST_BID', 'Post your Bid');
define ('MSG_BID_SEALED', 'Sealed');
define ('MSG_PROJECT_POSTER', 'Project Poster');
define ('MSG_ADDITIONAL_FILE', 'Additional File');
define ('MSG_CANTBID_BID_EXISTS', 'You have already placed a bid on this auction.');
define ('MSG_BID_DESCRIPTION_EMPTY', 'The bid description field cannot be empty.');
define ('MSG_DELIVERY_WITHIN', 'Delivery Within');
define ('MSG_RB_DESCRIPTION_EXPL', 'Describe how you will fulfill the project requirements. ');
define ('MSG_RB_DELIVERY_EXPL', 'Optional. Enter the number of days you will need to complete the project once your bid has been accepted.');
define ('MSG_TO_ACTIVATE_YOUR_BID', 'to activate your bid');
define ('MSG_YOUR_BID_ON_AUCTION', 'Your bid on auction');
define ('MSG_SEARCH_REVERSE_AUCTIONS', 'Search Reverse Auctions');
define ('MSG_FEATURED_REVERSE_AUCTIONS', 'Featured Reverse Auctions');
define ('MSG_BIDS_PLACED', 'Bids Placed');
define ('MSG_BIDDER_USERNAME', 'Bidder Username');
define ('MSG_BIDDER_DETAILS', 'Bidder Details');
define ('MSG_VIEW_PROFILE', 'Bidder Profile');
define ('MSG_REVIEWS', 'Reviews');
define ('MSG_REVIEWS_S', 'reviews');
define ('MSG_BID_DATE', 'Bid Date');
define ('MSG_USER_PROFILE', 'User Profile');
define ('MSG_RATING_AS_PURCHASER', 'Rating As Purchaser');
define ('MSG_RATING_AS_PROVIDER', 'Rating As Provider');
define ('MSG_FROM_PROVIDERS', 'From Providers');
define ('MSG_FROM_PURCHASERS', 'From Purchasers');
define ('MSG_POSITIVE_COMMENTS', 'positive');
define ('MSG_ACCEPT_BID', 'Accept');
define ('MSG_DECLINE_BID', 'Decline');
define ('MSG_FILTER_BIDS', 'Filter Bids');
define ('MSG_RA_WINNER_AWARDED_SUCCESS', 'You have successfully selected this bid as a winning bid for the auction.');
define ('MSG_RA_WINNER_AWARDED_FAILURE', 'Error: You cannot select this bid as a winning bid.');
define ('MSG_RA_BID_DECLINED_SUCCESS', 'The bid has been declined successfully.');
define ('MSG_RA_BID_DECLINED_FAILURE', 'Error: This bid cannot be declined.');
define ('MSG_INVALID_OPTION_SELECTED', 'Error: Invalid option selected.');
define ('MSG_THE_WINNING_BID', 'The winning bid');
define ('MSG_NO_BIDS_PLACED', 'There are no bids matching the selected filter.');
define ('MSG_PMB', 'Project Message Board');
define ('MSG_REVERSE_AUCTION', 'Reverse Auction');
define ('MSG_PROVIDER_CONTACT_DETAILS', 'Provider Contact Details');
define ('MSG_POSTER_CONTACT_DETAILS', 'Auction Poster Contact Details');
...
define ('MSG_MM_POPULAR', 'Popular');
define ('MSG_EMBEDDED_CODE_NOTE', 'Note: Please enter the embedded code, the URL is not supported');
define ('MSG_MEMBER_TIPS_A', 'Tip: Review your <a href="members_area.php?page=selling&section=prefilled_fields">global/prefilled fields</a> settings');
define ('MSG_MEMBER_TIPS_B', 'Selling?  Set up your <a href="members_area.php?page=selling&section=postage_setup">postage options</a> now.');
define ('MSG_BID_PLACED_DURATION_CHANGE_A', 'Note: If the time left is greater, your item\'s duration will be reduced to');
define ('MSG_BID_PLACED_DURATION_CHANGE_B', 'days once it receives it\'s first bid');
define ('MSG_CONTINUE_SHOPPING', 'Continue Shopping');
define ('MSG_YOUR_STORE_URL', 'Your Store URL');
define ('MSG_RETRACT_CONFIRM_ADMIN', 'Are you sure you want to retract all the bids placed by this user on this auction?');
define ('MSG_ACC_VERIFY_EMAIL_SUCCESS', 'Your email address has been successfully verified. <br>You can now login using your username and password if the account has been approved by the administrator.');
...
define ('MSG_INVOICE_ERROR_PRICE_NOT_ALLOWED', '<b>Invoice Error</b>: You cannot set a winning bid which is higher than the original sale price.');
define ('MSG_BULK_START_TIME_NOTES', 'Leave empty if "start_time_type" is set to "now" or enter a unix timestamp if "start_time_type" is set to "custom"');
define ('MSG_START_TIME_TYPE', 'Start Time Type');
define ('MSG_BULK_START_TIME_TYPE_NOTES', 'Leave empty or enter "now" if the auction should start as soon as its activated.');
define ('MSG_BULK_END_TIME_NOTES', 'Leave empty if "end_time_type" is set to "duration" or enter a unix timestamp if "end_time_type" is set to "custom"');
define ('MSG_END_TIME_TYPE', 'End Time Type');
define ('MSG_BULK_DURATION_NOTES', 'The duration values are in days.<br>Leave empty if "end_time_type" is set to "custom"');
define ('MSG_BULK_QUANTITY_NOTES', 'Leave empty or enter "1" if listing a standard or first bidder auction, or enter a value greater than "2" if listing a dutch auction.');
define ('MSG_BULK_CATEGORY_NOTES', 'Please [ <a href="javascript:;" onclick="bulk_popup_categories_open();">click here</a> ] to get a list of the site\'s categories and their corresponding ids.');
define ('MSG_BULK_BUYOUT_PRICE_NOTES', 'This field needs to be equal or higher than the start price field.<br>Leave empty or enter 0 if you dont want to enable buy out for an auction.');
define ('MSG_IMPORT_SUCCESSFUL', 'The import was successful.');
define ('MSG_BULK_IMPORTER_OUTPUT', 'Bulk Importer Output');
define ('MSG_PENDING_BULK_LISTINGS', 'Pending Bulk Listings');
define ('MSG_LIST', 'List');
define ('MSG_LIST_ALL', 'List all');
define ('MSG_DELETE_ALL', 'Delete all');
define ('MSG_PROCEED_CONFIRM', 'Are you sure you want to proceed?');
define ('MSG_PENDING_BULK_LISTINGS_DELETED', 'The pending bulk listings you have selected for removal have been deleted successfully.');
define ('MSG_BULK_MIN_OFFER_NOTES', 'Optional. If set, you must also set the maximum offer amount.');
define ('MSG_BULK_MAX_OFFER_NOTES', 'Optional. If set, it requires a value greater than the minimum offer amount.');
define ('MSG_BULK_BID_INCREMENT_NOTES', 'Optional. Leave empty or enter 0 if you wish for the default bid increment implemented 
on the site or enter an amount you wish to use a custom fixed bid increment value.');
define ('MSG_BULK_COUNTRY_NOTES', 'Please [ <a href="javascript:;" onclick="bulk_popup_countries_open();">click here</a> ] to get a list of the site\'s countries and their corresponding ids.');
define ('MSG_BULK_SHIP_METHOD_NOTES', '1 - Buyer pays for shipping expenses<br>2 - Seller pays for shipping expenses');
define ('MSG_BULK_YES_NO_NOTES', '1 - Enabled<br>0 - Disabled');
define ('MSG_BULK_FIRST_BIDDER_NOTE', 'Note: Only mandatory if you are creating a first bidder auction. Otherwise not applicable.');
define ('MSG_SELECT', 'Select');
define ('MSG_ACTIVE_STORES', 'active stores');
define ('MSG_ITEMS_PER_PAGE', 'Items per page');
define ('MSG_ALL_ITEMS', 'All Items');
define ('MSG_AUCTIONS_ONLY', 'Auctions Only');
define ('MSG_STORE_ITEMS', 'Store Items');
define ('MSG_BUY_OUT_ITEMS', 'Buy Out Items');
define ('MSG_ITEMS_FOUND', 'items found');
define ('MSG_REMOVAL_SUCCESSFUL', 'Removal Successful');
define ('MSG_CHANGING', 'changing...');
define ('MSG_INVALID_FILE_TYPE', 'Error: Invalid file type specified.');
define ('MSG_ENABLE_ITEM_COUNTER', 'Show Views Counter');
define ('MSG_ENABLE_ITEM_COUNTER_EXPL', 'If this setting is enabled, the views counter will be shown on the auction details page.');
define ('MSG_STORE_META_DESC', 'Store Meta Description');
define ('MSG_STORE_META_DESC_EXPL', 'Optional. Enter a meta description for your store.');
define ('MSG_BULK_MEDIA_IMAGE_NOTE', 'Please enter the paths/urls for your files in the following format: <br>
{local_path}/image.gif|{remote_url}/image.gif<br>
All paths/urls need to be separated by the "|" character.<br>
You can add a maximum of ' . $setts['max_images'] . ' images to an auction.');
define ('MSG_BULK_MEDIA_VIDEO_NOTE', 'Please enter the paths/urls for your files in the following format: <br>
{local_path}/movie.avi|{remote_url}/movie.avi<br>
All paths/urls need to be separated by the "|" character.<br>
You can add a maximum of ' . $setts['max_media'] . ' videos to an auction.');
define ('MSG_BULK_MEDIA_DD_NOTE', 'Please enter the paths/urls for your files in the following format: <br>
{local_path}/file.ext<br>
All paths/urls need to be separated by the "|" character.<br>
You can add a maximum of ' . $setts['max_dd'] . ' files to an auction.');
define ('MSG_CUSTOM_FIELDS', 'Custom Fields');
define ('MSG_BULK_CUSTOM_FIELDS_NOTES', 'Please [ <a href="javascript:;" onclick="bulk_popup_custom_fields_open();">click here</a> ] to get a list of the site\'s custom fields and their corresponding ids.');
define ('MSG_TEXT', 'text');
define ('MSG_SHOW_WANTED_ADS', 'Show Wanted Ads');
define ('MSG_OF_START_PRICE', ' of max. start/reserve price');
define ('AMSG_EMAIL_SELLER', 'Email Seller');
define ('MSG_GOTO_MY_INVOICES', 'Go To My Invoices Page');
define ('MSG_SHOWING_INVOICE_ID', 'Showing Invoice ID');
define ('MSG_STORE_SETTINGS', 'Store Settings');
define ('MSG_SUBSCRIPTION_SETTINGS', 'Subscription Settings');
define ('MSG_STORE_PASSWORD', 'Store Password');
define ('MSG_STORE_PASSWORD_EXPL', 'Optional field. If you enter a password for your store, users will only be able to access your store and store only listed items if they enter this password when prompted.');
define ('MSG_PROTECTED_PAGE_LOGIN', 'Protected Page Login');
define ('MSG_PROTECTED_PAGE_LOGIN_TITLE', 'You are trying to access protected page. Please enter the password set for this page in order to proceed.');
define ('MSG_GATEWAY_SETTINGS', 'Gateway Settings');
define ('MSG_DIRECT_PAYMENT_METHODS_SET_EXPL', 'Click on the name of a payment gateway to enter/update it\'s details');
define ('MSG_SORT_BY', 'Sort By');
define ('MSG_PAGE', 'Page');
define ('MSG_ORDER_CLOSING_SOON', 'Closing Soon');
define ('MSG_ORDER_RECENTLY_LISTED', 'Recently Listed');
define ('MSG_REFINE_SEARCH', 'Filter Results');
define ('MSG_LISTING_OPTIONS', 'Listing Options');
define ('MSG_SELECTED', 'Selected');
define ('MSG_RESET', 'Reset');
define ('MSG_ITEM_FOUND', 'item found');
define ('MSG_ENTER_ZIP_CODE', 'Zip Code');
define ('MSG_RELIST_AUCTION_CONFIRM', 'Are you sure you want to relist this auction?');
define ('MSG_RELIST_AUCTION', 'Relist Auction');
define ('MSG_DISABLE_SNIPING', 'Disable Sniping Feature');
define ('MSG_DISABLE_SNIPING_EXPL', 'Check this checkbox if you want to disable the sniping feature for this auction.');
define ('MSG_SHOW_MAKEOFFER_RANGES', 'Show Make Offer Price Ranges');
define ('MSG_SHOW_MAKEOFFER_RANGES_EXPL', 'If you enable this feature, the minimum and maximum offer range accepted on your auctions are shown to the potential buyers. Otherwise these values are hidden.');
define ('MSG_LISTED_FOR', 'Listed for');
define ('MSG_SOLD_ITEMS', 'Sold Items');
define ('MSG_UNSOLD_ITEMS', 'Unsold Items');
define ('MSG_POSTAGE_TYPE_SHIPPING_CARRIERS_EXPL', 'You can use the site\'s default calculation table, your own calculation table, or the postage can be calculated using one of 
the shipping carriers available.');
define ('MSG_SHIPPING_CARRIERS', 'Shipping Carriers');
define ('MSG_CHOOSE_CARRIERS', 'Choose Shipping Carriers');
define ('MSG_POUNDS', 'lbs');
define ('MSG_SHIPPING_CARRIER', 'Shipping Carrier');
define ('MSG_SHIPPING_METHOD', 'Shipping Method');
define ('MSG_NO_SHIPPING_METHODS_AVAILABLE', 'No shipping methods available');
define ('MSG_SELECT_METHOD', 'Select Method');
define ('MSG_PLEASE_SELECT_SHIPPING_METHOD', 'Please select shipping method');
define ('MSG_PAYMENT_ERROR_CREATE_INVOICE_1', 'Please ');
define ('MSG_PAYMENT_ERROR_CREATE_INVOICE_2', 'create an invoice');
define ('MSG_PAYMENT_ERROR_CREATE_INVOICE_3', ' for this item in order to be able to pay for it using direct payment.');
define ('MSG_ERROR_BANK_POPUP', 'Fatal error: cannot generate bank details popup.');
define ('MSG_SETUP_FEES_SCHEDULED_NOTE', 'The auction setup fees will be charged when the auction will start.');
define ('MSG_OFFER_DECLINED_SUCCESS', 'The offer has been declined successfully.');
define ('MSG_DECLINE_CONFIRM', 'Are you sure you want to decline this offer?');
define ('MSG_DECLINE', 'Decline');
define ('MSG_WIDTHDAW', 'Withdraw');
define ('MSG_WITHDRAW_CONFIRM', 'Are you sure you want to withdraw this offer?');
define ('MSG_OFFER_WITHDRAWN_SUCCESS', 'The offer has been withdrawn successfully.');
define ('MSG_WITHDRAWN', 'Withdrawn');
define ('MSG_RELISTED_ITEMS', 'Relisted Items');
define ('MSG_MM_ITEMS_WITH_OFFERS', 'Items with Offers');
define ('MSG_LIMIT_BIDS', 'Limit Number of Bids');
define ('MSG_LIMIT_BIDS_EXPL', 'Enter a positive value if you want to limit the number of bids a user can make on an auction. Proxy bids will not count if when this limit is set.<br>Enter 0 in the field above if you want to disable this limitation.');
define ('MSG_LIMIT_OFFERS', 'Limit Number of Offers');
define ('MSG_LIMIT_OFFERS_EXPL', 'Enter a positive value if you want to limit the number of offers a user can make on an auction. <br>Enter 0 in the field above if you want to disable this limitation.');
define ('MSG_CANTBID_BID_LIMIT_REACHED', 'You cannot bid on this item anymore because you have reached the maximum number of bids allowed by the seller for this auction.');
define ('MSG_CANTBID_OFFER_LIMIT_REACHED', 'You cannot make an offer on this item anymore because you have reached the maximum number of offers placed allowed by the seller for this auction.');
define ('MSG_ENTER_DECLINE_REASON', 'Enter a reason for declining this offer (optional)');
define ('MSG_SAVE_SEARCH', 'Save Search');
define ('MSG_SEARCH_SAVED', 'Search Saved');
define ('MSG_SELECT_SAVED_SEARCH', '-- Select Saved Search --');
define ('MSG_DELETE_SEARCH', 'Delete Search');
define ('MSG_MM_SELLER_VOUCHERS', 'Seller Vouchers');
define ('MSG_ADD_VOUCHER', 'Add Voucher');
define ('MSG_VOUCHER_NAME', 'Voucher Name');
define ('MSG_VOUCHER_REDUCTION', 'Reduction');
define ('MSG_VOUCHER_REDUCTION_EXPL', 'Enter a percentage reduction that will apply to the buy out price of your items.');
define ('MSG_START_DATE', 'Start Date');
define ('MSG_VOUCHER_DURATION_EXPL', 'Enter the duration in days until this voucher expires. Leave empty or enter 0 if you wish to apply an unlimited duration.');
define ('MSG_NB_OF_USES', 'Number of Uses');
define ('MSG_NB_OF_USES_EXPL', 'Enter the number of times this voucher can be used. Leave empty or enter 0 if you wish for buyers to be able to use this voucher an
unlimited number of times.');
define ('MSG_VOUCHER_CODE', 'Voucher Code');
define ('MSG_VOUCHER_DETAILS', 'Voucher Details');
define ('MSG_USES_LEFT', 'Uses Left');
define ('MSG_ADD_EDIT_VOUCHER', 'Add/Edit Voucher');
define ('MSG_VOUCHER_CODE_EXPL', 'Optional. If you leave this field empty, a voucher code will be automatically generated.');
define ('MSG_INSURANCE_INCLUDED', 'Insurance Included');
define ('MSG_REMOVE_INSURANCE', 'Remove Insurance');
define ('MSG_INSURANCE_REMOVED_SUCCESS', 'The insurance has been removed successfully.');
define ('MSG_OVERRIDE_TAX_RATE', 'Set/Override Tax Rate');
define ('MSG_OVERRIDE_TAX_RATE_EXPL', 'Optional. Enter a tax rate which will apply to all your items. This tax rate will only apply for users who reside within the same State as you.');
define ('MSG_DEFAULT_TAX_FOR_YOUR_LOCATION', 'Default tax for your location');
define ('MSG_STATE_TAX', 'State Tax');
define ('MSG_BULK_LISTING_EDIT_SUCCESS', 'The bulk listing has been edited successfully.');
define ('MSG_MM_SAVED_SEARCHES', 'Saved Searches');
define ('MSG_URL', 'URL');
define ('MSG_ADD_INSURANCE', 'Add Insurance');
define ('MSG_INSURANCE_ADDED_SUCCESS', 'The insurance has been added successfully.');
define ('MSG_SHOW_WATCHED_LIST', 'Display Item Watched Box');
define ('MSG_SHOW_WATCHED_LIST_EXPL', 'If this setting is enabled, the "Item watched by" box will be shown on the auction details pages.');
define ('MSG_SAVE', 'Save');
define ('MSG_EDIT_NAME', 'Edit Name');
define ('MSG_INVOICE_DELETED_SUCCESS', 'The invoice has been deleted successfully.');

define ('MSG_BIDDER_STATUS', 'Bidder Status');
define ('MSG_TO_BECOME_A_VERIFIED_BIDDER', 'to become a verified bidder');
define ('MSG_BIDDER_VERIFIED', 'You have been successfully verified as a bidder.<br>Thank you.');
define ('MSG_YOU_MUST_BE_A_VERIFIED_BIDDER_TO_BID', 'You must be a verified bidder to be able to bid on this auction.<br>
[ <a href="fee_payment.php?do=bidder_verification">Click here</a> ] to become verified.');
define ('MSG_FRMCHK_DUPLICATE_SHOP_NAME', 'The Store Name you have chosen already exists in our database.');

define ('MSG_UNLIMITED', 'Unlimited');
define ('MSG_RESERVE_NOT_MET_SHORT', 'Reserve Not Met');
define ('MSG_VACATION_MODE', 'Vacation Mode');
define ('MSG_VACATION_MODE_EXPL', 'If the checkbox above is checked, a message will appear on all your auctions which will let visitors know that you are currently on vacation.');
define ('MSG_VACATION_MODE_DESCRIPTION', 'The seller is currently on vacation.');
define ('MSG_MESSAGE_EMPTY', 'Error: Please enter a message.');
define ('', '');
define ('', '');
?>
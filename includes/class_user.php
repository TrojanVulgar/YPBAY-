...
class user extends custom_field
{
	...
	{
		list($first_name, $last_name) = @explode(' ', $user_details['name']);
		
		$user_details['paypal_first_name'] = (!empty($user_details['paypal_first_name'])) ? $user_details['paypal_first_name'] : $first_name;
		$user_details['paypal_last_name'] = (!empty($user_details['paypal_last_name'])) ? $user_details['paypal_last_name'] : $last_name;
		...
		$user_details['paypal_country'] = (!empty($user_details['paypal_country'])) ? $user_details['paypal_country'] : $this->get_sql_field("SELECT country_iso_code FROM " . DB_PREFIX . "countries WHERE id='" . $user_details['country'] . "'", 'country_iso_code');

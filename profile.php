...
if (item::count_contents($user_details) && $setts['enable_profile_page'])
{
	...
	$user_details['profile_www'] = ((!empty($user_details['profile_www']) && !eregi('http://', $user_details['profile_www']) && !eregi('https://', $user_details['profile_www'])) ? 'http://' : '') . $user_details['profile_www'];

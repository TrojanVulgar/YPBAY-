...
<table width="100%" border="0" cellpadding="3" cellspacing="2">
   ...
   <tr>
      <td class="c4" colspan="2"><strong>
         <?=GMSG_ENDAUCTION_FEE;?>
         - <? echo (eregi('s', $fee_row['endauction_fee_applies'])) ? MSG_PAID_BY_SELLER : MSG_PAID_BY_BUYER; ?></strong> </td>
   </tr>
	<?=$sale_fees_table;?>
   <tr>
   	<td colspan="2" class="c3"></td>
...
<table width="100%" border="0" cellpadding="3" cellspacing="2">
   ...
   <? } ?>
   <? if ($fee_row['swap_fee']>0 || $setts['display_free_fees']) { ?>
   <tr class="c2">
      <td align="right" width="50%"><strong>
         <?=GMSG_SWAP_FEE;?>
         </strong></td>
   ...
   <? } ?>
   <? if ($fee_row['video_fee']>0 || $setts['display_free_fees']) { ?>
   <tr class="c2">
      <td align="right" width="50%"><strong>
         <?=GMSG_MEDIA_UPL_FEE;?>
         </strong></td>
   ...
   <? } ?>
   <? if ($fee_row['dd_fee']>0 || $setts['display_free_fees']) { ?>
   <tr class="c2">
      <td align="right" width="50%"><strong>
         <?=GMSG_DD_FEE;?>
         </strong></td>
   ...
   <? } ?>
   <? if ($fee_row['wanted_ad_fee']>0 || $setts['display_free_fees']) { ?>
   <tr class="c5">
      <td colspan="2"></td>
   </tr>
   <tr class="c2">
...
<table width="100%" border="0" cellpadding="3" cellspacing="2">
   ...
   <? } ?>
   <? if ($reverse_fees['video_fee']>0 || $setts['display_free_fees']) { ?>
   <tr class="c2">
      <td align="right" width="50%"><strong>
         <?=GMSG_MEDIA_UPL_FEE;?>
         </strong></td>
   ...
   <? } ?>
   <? if ($reverse_fees['dd_fee']>0 || $setts['display_free_fees']) { ?>
   <tr class="c2">
      <td align="right" width="50%"><strong>
         <?=GMSG_DD_FEE;?>
         </strong></td>
...
<? if ($is_reverse_sale_fee) { ?>
   ...
   <tr>
      <td class="c4" colspan="2"><strong>
         <?=GMSG_ENDAUCTION_FEE;?>
         - <? echo (eregi('s', $reverse_fees['endauction_fee_applies'])) ? MSG_PAID_BY_SELLER : MSG_PAID_BY_BUYER; ?></strong> </td>
   </tr>

...
<table width="100%" border="0" cellpadding="3" cellspacing="2" class="border">
   ...
   <input type="hidden" name="listing_type" value="full" />
   <? } else if ($auction_edit == 1) { ?>
   ...
   <tr class="c1">
      ...
      <td class="contentfont"><span id="main_category_display"><?=$main_category_display;?></span>
      	[ <a href="javascript:;"  onClick="select_category(document.getElementById('category_id').value, 'main_category_field', 'main_', false, true);"><?=GMSG_SELECT;?></a> ]</td>
   </tr>
   ...
   <tr class="c1">
      ...
      <td class="contentfont"><span id="addl_category_display"><?=$addl_category_display;?></span>
      	[ <a href="javascript:;"  onClick="select_category(document.getElementById('addl_category_id').value, 'addl_category_field', 'addl_', false, true);"><?=GMSG_SELECT;?></a> ]</td>
   </tr>

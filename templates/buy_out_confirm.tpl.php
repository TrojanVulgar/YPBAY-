...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
   <form action="buy_out.php" method="post">
         ...
         <td class="contentfont"><table width="100%" border="0" cellpadding="3" cellspacing="2">
               ...
               <tr class="c1">
                  <td width="150" align="right"><strong>
                     <?=MSG_BUYOUT_PRICE;?></strong></td>
                  <td><?=$fees->display_amount($item_details['buyout_price'], $item_details['currency']); ?></td>
               </tr>
               ...
               <tr class="c4">
                  ...
                  <td></td>
				   ...
				   <? } ?>
				   <tr class="c1">
                  <td width="150" align="right"><b><?=MSG_VOUCHER_CODE;?></b></td>
				      <td><input type="text" name="voucher_code" value="<?=$_POST['voucher_code'];?>" size="25" /></td>
				   </tr>
               <tr class="c4">
                  <td></td>
                  <td></td>
               </tr>
               <? if ($auction_tax['apply']) { ?>
               <tr class="c1">

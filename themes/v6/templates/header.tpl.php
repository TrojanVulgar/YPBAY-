...
<tr>
   <td width="100%"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" background="themes/<?=$setts['default_theme'];?>/img/headbg.gif">
         <tr valign="top" height="97">
            ...
            <td width="260" style="background-image:url(themes/<?=$setts['default_theme'];?>/img/logo_bg.gif); background-repeat: no-repeat;" align="center" valign="middle"><div><a href="index.php"><a href="<?=$index_link;?>"><img src="images/probidlogo.gif?<?=rand(2,9999);?>" alt="Professional Auction Script Software by PHP Pro Bid" border="0"></a></div>
            ...
            <td width="100%" class="toplink" style="padding-top: 29px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr valign="top" align="left">
                     ...
                     <? }  if ($setts['enable_stores']) {	if (eregi("stores.php",$_SERVER['PHP_SELF'])) { ?>
                     <td width="16"><img src="themes/<?=$setts['default_theme'];?>/img/db_bg.gif" width="16" height="30"></td>
                     ...
                     <? } }  if ($setts['enable_reverse_auctions']) {	if (eregi("reverse_auctions.php",$_SERVER['PHP_SELF'])) { ?>
                     <td width="16"><img src="themes/<?=$setts['default_theme'];?>/img/db_bg.gif" width="16" height="30"></td>
                     ...
                     <? } } if ($setts['enable_wanted_ads']) { if (eregi("wanted_ads.php",$_SERVER['PHP_SELF'])) { ?>
                     <td width="16"><img src="themes/<?=$setts['default_theme'];?>/img/db_bg.gif" width="16" height="30"></td>
                     ...
                     <? } if ($layout['enable_site_fees_page']) { if (eregi("site_fees.php",$_SERVER['PHP_SELF'])) { ?>
                     <td width="16"><img src="themes/<?=$setts['default_theme'];?>/img/db_bg.gif" width="16" height="30"></td>

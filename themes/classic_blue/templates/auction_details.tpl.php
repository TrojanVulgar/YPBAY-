...
<table width='100%' border='0' cellspacing='0' cellpadding='0' height='22' style='border-top: 2px solid #074170;'>
   <tr bgcolor='#0C6CBB' height='21'>
      <td width='70%' class="itemid">&nbsp;&nbsp;&raquo;&nbsp;
         <?=$item_details['name'];?></td>
      <td width='30%' class="itemidend" align="right"><?=MSG_AUCTION_ID;?>
         : <b>
...
<table width="100%" border="0" cellpadding="0" cellspacing="2">
   <tr valign="top">
      ...
      <td width="30%" class="border">
      	<table width="100%" border="0" cellspacing="3" cellpadding="3">
            <tr>
               <td class="c4"><?=MSG_SELLER_INFORMATION;?> </td>
            </tr>
            <tr class="c5">
               <td><img src="themes/<?=$setts['default_theme'];?>/img/pixel.gif" width="1" height="1"></td>
            </tr>
...
<table width="100%" border="0" cellspacing="3" cellpadding="3" class="border">
   <tr>
      <td class="c4" colspan="2"><strong><?=GMSG_DESCRIPTION;?></strong></td>
   </tr>
	<tr class="c5">
   ...
   <tr>
      <td class="c4" colspan="2"><strong><?=MSG_AUCTION_IMAGES;?></strong> </td>
   </tr>
	<tr class="c5">
		<td><img src="themes/<?=$setts['default_theme'];?>/img/pixel.gif" width="1" height="1"></td>
		<td><img src="themes/<?=$setts['default_theme'];?>/img/pixel.gif" width="1" height="1"></td>
   ...
   <tr>
      <td class="c4" colspan="2"><strong><?=MSG_AUCTION_MEDIA;?></strong> </td>
   </tr>
	<tr class="c5">
		<td><img src="themes/<?=$setts['default_theme'];?>/img/pixel.gif" width="1" height="1"></td>
		<td><img src="themes/<?=$setts['default_theme'];?>/img/pixel.gif" width="1" height="1"></td>
   ...
   <tr>
      <td class="c4" colspan="2"><?=MSG_DIRECT_PAYMENT;?></td>
   </tr>
	<tr class="c5">
		<td><img src="themes/<?=$setts['default_theme'];?>/img/pixel.gif" width="1" height="1"></td>
		<td><img src="themes/<?=$setts['default_theme'];?>/img/pixel.gif" width="1" height="1"></td>
   ...
   <tr>
      <td class="c4" colspan="2"><?=MSG_OFFLINE_PAYMENT;?></td>
   </tr>
	<tr class="c5">
		<td><img src="themes/<?=$setts['default_theme'];?>/img/pixel.gif" width="1" height="1"></td>
		<td><img src="themes/<?=$setts['default_theme'];?>/img/pixel.gif" width="1" height="1"></td>
...
<? } ?>
            ...
            <tr>
               <td class="c4" colspan="2"><?=MSG_SHIPPING;?></td>
            </tr>
	         <tr class="c5">
		         <td><img src="themes/<?=$setts['default_theme'];?>/img/pixel.gif" width="1" height="1"></td>
		         <td><img src="themes/<?=$setts['default_theme'];?>/img/pixel.gif" width="1" height="1"></td>
...
<table width="100%" border="0" cellpadding="3" cellspacing="3" class="border">
   <tr>
      <td class="c4" colspan="<?=$layout['hpfeat_nb'];?>"><?=MSG_OTHER_ITEMS_FROM_SELLER;?></td>
   </tr>
   <tr>
      <?
...
<table width="100%" border="0" cellpadding="3" cellspacing="3" class="border">
	...
	<? } ?>
   <tr>
      <td class="c4" colspan="2"><?=MSG_BID_ON_THIS_ITEM;?></td>
   </tr>
   <tr>

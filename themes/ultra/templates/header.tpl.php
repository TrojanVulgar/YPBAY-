...
<body bgcolor="#f5f6f7" leftmargin="5" topmargin="5" marginwidth="5" marginheight="5">
<table width="980" border="0" align="center" cellpadding="10" cellspacing="0">
<tr>
   <td>
   <table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr valign="bottom">
         <td style="padding-bottom: 10px;"><a href="<?=$index_link;?>"><img src="images/probidlogo.gif?<?=rand(2,9999);?>" alt="Professional Auction Script Software by PHP Pro Bid" border="0"></a></td>
   ...
   <table width="100%" border="0" cellspacing="0" cellpadding="0" background="themes/<?=$setts['default_theme'];?>/img/subbg.gif">
      <tr align="center">
         ...
         <td nowrap width="<?=$header_cell_width;?>" <? if (eregi("categories.php",$_SERVER['PHP_SELF'])) { ?>class="db" <? } else { ?> class="lb" ONMOUSEOVER="this.className='db';" ONMOUSEOUT="this.className='lb';"<? } ?>>
         ...
         <? } ?>
			<? } ?>
         <!-- Members Area Menu -->
         <td nowrap <? if (eregi("members_area.php",$_SERVER['PHP_SELF'])||eregi("login.php",$_SERVER['PHP_SELF'])) { ?> class="db" <? } else { ?> class="lb" ONMOUSEOVER="this.className='db';" ONMOUSEOUT="this.className='lb';" <? } ?> width="<?=$header_cell_width;?>">

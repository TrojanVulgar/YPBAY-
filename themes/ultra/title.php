...
function header1($head_title) {
	...
	return "<table width='100%' border='0' cellspacing='0' cellpadding='0'>
        <tr>
        <td width='5'><img src='themes/".$setts['default_theme']."/img/partb1.gif' width='5' height='35'></td>
        <td width='100%' class='partb' background='themes/".$setts['default_theme']."/img/partb_bg.gif'>$head_title</td>
        <td width='5'><img src='themes/".$setts['default_theme']."/img/partb2.gif' width='5' height='35'></td>
        </tr>
        </table>
...
return "<table width='100%' border='0' cellspacing='0' cellpadding='0'>
        <tr>
        <td width='5'><img src='themes/".$setts['default_theme']."/img/partg1.gif' width='5' height='35'></td>
        <td width='100%' class='partb' background='themes/".$setts['default_theme']."/img/partg_bg.gif'>$head_title</td>
        <td width='5'><img src='themes/".$setts['default_theme']."/img/partg2.gif' width='5' height='35'></td>
        </tr>
        </table>
        <div><img src='themes/".$setts['default_theme']."/img/pixel.gif' width='1' height='3'></div>";
}
...
function header6($head_title) {
	...
	return "<table width='100%' border='0' cellspacing='0' cellpadding='0'>
        <tr>
        <td width='5'><img src='themes/".$setts['default_theme']."/img/party1.gif' width='5' height='35'></td>
        <td width='100%' class='party' background='themes/".$setts['default_theme']."/img/party_bg.gif'>$head_title</td>
        <td width='5'><img src='themes/".$setts['default_theme']."/img/party2.gif' width='5' height='35'></td>
        </tr>
        </table>
        <div><img src='themes/".$setts['default_theme']."/img/pixel.gif' width='1' height='3'></div>";
}

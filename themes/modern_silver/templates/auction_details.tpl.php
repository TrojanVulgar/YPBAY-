...
<SCRIPT LANGUAGE = "JavaScript">
	...
	window.onload=function(){
		setTimeout(function(){refresh_countdown('time_left', <?=$item_details['auction_id'];?>)}, 1000);
	}
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" class="subitem">
   <tr class="contentfont" align="center">
      <td><table width=100%>
            <tr>
               ...
               <td align="center" width="100%">
                  ...
                  [ <a href="<?=process_link('sell_item', array('option' => 'sell_similar', 'auction_id' => $item_details['auction_id']));?>">
                  <?=MSG_SELL_SIMILAR;?>
                  </a> ]<br>
                  <? if (!$item->under_time($item_details))	{ ?>
                  <? if ($item_details['nb_bids']==0 && $item_details['active']==1)	{ ?>
                  [ <a href="edit_item.php?auction_id=<?=$item_details['auction_id'];?>&edit_option=new">
                  <?=MSG_EDIT_AUCTION;?>
                  </a> ]<br>
                  [ <a href="members_area.php?do=delete_auction&auction_id=<?=$item_details['auction_id'];?>&page=selling&section=open" onclick="return confirm('<?=MSG_DELETE_CONFIRM;?>');">
                  <?=MSG_DELETE;?>
                  </a> ]<br>
               ...
               <td width="100%"><?=MSG_STATUS_BIDDER_SELLER_A;?>
                  <br>
      ...
      <td align="center" class="leftborder" nowrap width="22%"><a href="javascript:popUp('<?=process_link('auction_print', array('auction_id' => $item_details['auction_id']));?>');"><img src="themes/<?=$setts['default_theme'];?>/img/system/print.gif" align="absmiddle" border="0" hspace="5">
         <?=MSG_PRINT_VIEW;?>
         </a></td>
      <td align="center" class="leftborder" nowrap width="22%"><a href="<?=process_link('auction_details', array('auction_id' => $item_details['auction_id'], 'option' => 'item_watch'));?>"><img src="themes/<?=$setts['default_theme'];?>/img/system/watch.gif" align="absmiddle" border="0" hspace="5">
         <?=MSG_WATCH_ITEM;?>
         </a></td>
      <td align="center" class="leftborder" nowrap width="22%"><a href="<?=process_link('auction_details', array('auction_id' => $item_details['auction_id'], 'option' => 'auction_friend'));?>"><img src="themes/<?=$setts['default_theme'];?>/img/system/tofriend.gif" align="absmiddle" border="0" hspace="5">
         <?=MSG_SEND_TO_FRIEND;?>
         </a> &nbsp; &nbsp;</td>
   </tr>
...
<table width="100%" border="0" cellpadding="3" cellspacing="1">
   <tr valign="top">
      <td width="20%" align="center"><table width="100%" border="0" cellspacing="3" cellpadding="3">
            ...
            <tr>
               <td align="center"><table width="100%" border="0" cellspacing="1" cellpadding="1" class="border">
      ...
      <td width="30%"><table width="100%" border="0" cellspacing="2" cellpadding="3">
            <tr>
               <td class="c3"><?=MSG_SELLER_INFORMATION;?>
               </td>
            </tr>
            <tr class="c5">
               <td><img src="themes/<?=$setts['default_theme'];?>/img/pixel.gif" width="1" height="1"></td>
            ...
            <tr>
               <td><b>
                  ...
                  <?=user_pics($user_details['user_id']);?></td>
            </tr>
            <tr class="c1">
               <td><?=MSG_REGISTERED_SINCE;?>
                  <b>
   ...
   <tr>
      ...
      <td width="<?=$width;?>" align="center" valign="top"><?
         ...
         <table width="100%" border="0" cellspacing="3" cellpadding="3">
            ...
            <tr class="c3">
               <td colspan="2"><a style="color: #ffffff; font-weight: bold;" href="<?=$auction_link;?>">&raquo;
